...
CMD ["-DMYSQL_SCHEMA=${MYSQL_SCHEMA}","-DMYSQL_ADDRESS=${MYSQL_ADDRESS}","-DMYSQL_USERNAME=${MYSQL_USERNAME}","-DMYSQL_PASSWORD=${MYSQL_PASSWORD}","-DSMTP_HOST=${SMTP_HOST}","-DSMTP_USERNAME=${SMTP_USERNAME}","-DSMTP_PASSWORD=${SMTP_PASSWORD}","-DMAIL_DOMAIN=${MAIL_DOMAIN}"]
